...
public class CouleurCircuit extends javax.swing.JFrame {
     ...
     */
    public CouleurCircuit() {
        initComponents();
    }
    
    public void setCircuit(Circuit circ, PanelCircuit pan){
        m_circuit = circ;
        m_panelParent = pan;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CouleurCircuit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CouleurCircuit().setVisible(true);
            }
        });
    }
